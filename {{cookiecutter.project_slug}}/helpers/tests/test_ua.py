...
from helpers.ua import get_platform_bools
from helpers.ua import get_ua
from helpers.ua import get_ua_info
from helpers.ua import get_ua_platform


@pytest.mark.parametrize(
    ("user_agent,expected_platform",),  # noqa: PT006
    [
        (
            "Mozilla/5.0 (iPhone; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3",  # noqa: E501
            "mobile",
        ),
        (
            "Mozilla/5.0 (iPad; CPU OS 7_0 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11A465 Safari/9537.53",  # noqa: E501
            "tablet",
        ),
        (
...
@pytest.mark.parametrize(
    ("user_agent,expected_result",),  # noqa: PT006
    [
        (
            "Mozilla/5.0 (iPhone; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3",  # noqa: E501
            {
